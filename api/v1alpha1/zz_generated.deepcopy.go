...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecipeBackupPolicy) DeepCopyInto(out *RecipeBackupPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecipeBackupPolicy.
func (in *RecipeBackupPolicy) DeepCopy() *RecipeBackupPolicy {
	if in == nil {
		return nil
	}
	out := new(RecipeBackupPolicy)
	in.DeepCopyInto(out)
	return out
}
